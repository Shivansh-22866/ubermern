    ...
    <div className="p-7 flex flex-col justify-between h-screen">
      ...
      <img src="/uberlogo.png" className="w-16 mb-10" alt="Uber Logo" />
        <form onSubmit={(e) => handleSubmit(e)}>
          ...
          <p className="text-center py-8">New Here? {" "}
          <Link to={"/signup"} className="text-blue-700">Create new Account</Link></p>
        </form>
      </div>
      <div>
        <Link to={"/captainlogin"} className="flex flex-col items-center justify-center bg-yellow-600 text-white py-3 rounded w-full font-semibold">
          Sign in as Captain
        </Link>
      </div>
    </div>
